...
const campaigns = [
  {
    ...
    raised: "$12,450.00",
    image:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuAmIrH89H1WoK5kbT5zdmJBv2WE2E62b_dV3cGui1gt7vA5CP_EUUA75DAzYmH5VGtkQvd5NRtu3odoeTcOl7iK82HAwaUnFIZhCE5OeLNFhAmDrQ3WOjSRn9tqZZ6_o9ljEdw-cleN2LvkKMaQqQXYB6r6TaVSwHDN4YMbjiaF4iEHoptx2OMIGQQzbf30nIcqOgVJeI5Rc7nHcRuC45focx2gMj_k_ndsFQM1johbwNJWdh6iOAFCdknDu_WTu9kQWuFXopGNGP_1",
    alt: "Community water point",
  },
  {
    title: "Supplies for School Meals",
    summary: "Direct funding for nutritional lunch programs across 12 rural primary schools.",
    tag: "EDUCATION",
    tagClass: "bg-[color-mix(in_oklab,var(--ui-brand-brown)_85%,transparent)] text-white",
    progress: 42,
    raised: "$5,100.00",
    image:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuAmlprasK1ZXApONmJcNBq-x7lEL4u-AKhQ-Py683sGf5QIHyYm2YQkInJXej9VpKqaT0D-uhEBgzAYIOJIywQXwFTE1CQfGtRTGHo8ylnAVroMtTJqz-Cw4mkAE2xwwZ-YjwnOAiN3P3UwEao8PljdBxk5ctTzis1jecrdXP_P6IblteAAePxBOMt8WTQDmP46y1XBo9hY_lpfqNXq1xHe5Zhk5c2vmTnnKymUySC7R1Ckp_OsPnJL6IA7_VJO9kn0GNd1TnAIFnsv",
    alt: "School supplies",
  },
];
            ...
            {campaigns.map((c) => (
              ...
              >
                <div className="relative h-56 w-full overflow-hidden sm:h-64">
                  ...
                  />
                  <span
                    className={`absolute left-4 top-4 rounded-full px-3 py-1 text-xs font-bold tracking-widest ${c.tagClass}`}
                  >
                    {c.tag}
                  </span>
                </div>
                <div className="flex flex-1 flex-col justify-between gap-5 p-6 sm:p-8">
                  <div>
                    ...
                    <TextBody as="p" className="app-muted mt-2 leading-relaxed">
                      {c.summary}
                    </TextBody>
                    <div className="mt-5">
                      <div className="mb-2 flex items-baseline justify-between text-sm">
                        <span className="brand-green font-bold">Streaming Progress</span>
                        <span className="app-text font-semibold">{c.progress}% Complete</span>
                      </div>
                      <div
